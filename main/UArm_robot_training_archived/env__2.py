...
class UArmEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.spawn_z_values = [0.03, 0.075]
    ...
    def step(self, action=None):
        ...
        if (self.smallest_dist >= dist_to_goal):
            # print(f"New smallest distance: {dist_to_goal}")
            # print(f"Previous smallest distance: {smallest_dist}")
            self.smallest_dist = dist_to_goal
        else:
            reward -= abs(dist_to_goal-self.smallest_dist) # 
