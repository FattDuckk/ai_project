...
class UArmEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.goal_pos_red = np.array([red_goal_pos[0], red_goal_pos[1], 0.025])  # for the arm to reach, added box height
        ...
        self.goal_pos_green = np.array([green_goal_pos[0],green_goal_pos[1], 0.025])  # for the arm to reach, added box height
        ...
        self.goal_pos_blue = np.array([blue_goal_pos[0], blue_goal_pos[1], 0.25])
